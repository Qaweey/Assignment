...
namespace WeeklyTask1
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("Please enter the name of the first Newspaper");
            ...
            Console.WriteLine(firstMeanIncome);
            ...
            //{
            //    Console.WriteLine($"From the analysis it is advisable to go for {firstNewspaper} Newspaper because it has the highest average income of {M1} ");
            //}
            // if (M2>M1 && M2>M3 && M2>M4)
            //{
            //    Console.WriteLine($"From the analysis it is advisable to go for {secondNewspaper} Newspaper because it has the highest  average income of {M2} ");
            //}
            //if (M3>M1 && M3>M2 && M3>M4)
            //{
            //    Console.WriteLine($"From the analysis it is advisable to go for {thirdNewspaper} Newspaper because it has the highest  average income of {M3} ");
            //}
            // if (M4>M1&& M4>M2 && M4>M3)
            //{
            //    Console.WriteLine($"From the analysis it is advisable to go for {forthNewspaper} Newspaper because it has the highest  average income of {M4} ");
            //}
